                        ...
                        <form method="POST" accept-charset="UTF-8" id="newOrderForm">
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <select name="pickup_zone" id="pickupZone" class="form-select" required onchange="var d=document.getElementById('dropoffZone');if(this.value){d.disabled=false;d.removeAttribute('disabled');d.style.pointerEvents='auto';d.style.opacity='1';}else{d.disabled=true;d.setAttribute('disabled','disabled');d.value='';d.style.pointerEvents='';d.style.opacity='';}calculateDeliveryPrice();">
                                        <option value=""><?php echo $t['select_zone'] ?? 'Select zone'; ?></option>
                                        <?php foreach($zones as $key => $name): ?>
                                        <option value="<?php echo e($key); ?>"><?php echo ($lang == 'ar') ? $name : (($lang == 'fr' && isset($zones_fr[$key])) ? $zones_fr[$key] : $key); ?></option>
                                        <?php endforeach; ?>
